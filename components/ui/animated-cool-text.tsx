...
const Boat = () => (
    ...
    >
        ...
        <div className="w-16 h-6 bg-slate-700 rounded-b-xl"> {/* Boat base */}
            {/* Stick Figure */}
        ...
        <div className="w-1 h-12 bg-slate-800 absolute -top-12 left-7" /> {/* Mast */}
...
const AnimatedCoolText = () => {
    return (
        <div className="h-64 w-full flex items-center justify-center bg-gradient-to-b from-cyan-400 via-blue-600 to-blue-900 overflow-hidden">
